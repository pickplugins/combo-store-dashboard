...
const PopoverButton = (props) => {
	...
	var popoverClass = props.popoverClass ? props.popoverClass : ` ${position ? "absolute" : "mx-auto sm:w-3/4 md:w-2/4 fixed inset-x-0 top-10"}   z-20 border-2 border-solid border-indigo-600 rounded-sm`;
